 ...
 * (FlatList, TouchableOpacity) and the Ionicons glyphmap. With a cold jest cache
 ...
 */
beforeAll(() => {
    const view = render(<TransactionList transactions={[WITH_NOTE]} showDateHeaders={false} />);
    view.unmount();
}, 30_000);
